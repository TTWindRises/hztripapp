                                                    ...
                                                    .anchor(0.5f, 0.5f)
                                                            .extraInfo(b)
                                                                    .icon(BitmapDescriptorFactory
                                                                            .fromResource(R.drawable.ic_label_pink_200_18dp)));
                    ...
                    overlayList.add((new MarkerOptions())
                            .position(step.getExit().getLocation())
                                    .anchor(0.5f, 0.5f)
                                            .zIndex(10)
                                                    .icon(BitmapDescriptorFactory
                                                            .fromResource(R.drawable.routeplan_end)));
                    ...
                    .position(mRouteLine.getStarting().getLocation())
                            .icon(getStartMarker() != null ? getStartMarker() :
                                    BitmapDescriptorFactory
                                            .fromResource(R.drawable.ic_directions_bus_indigo_200_18dp)).zIndex(10));
        }
        // terminal
                    ...
                    .add((new MarkerOptions())
                            .position(mRouteLine.getTerminal().getLocation())
                                    .icon(getTerminalMarker() != null ? getTerminalMarker() :
                                            BitmapDescriptorFactory
                                                    .fromResource(R.drawable.ic_directions_bike_indigo_200_18dp)).zIndex(10));
        ...
        if (mRouteLine.getAllStep() != null
            ...
            for (WalkingRouteLine.WalkingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(2)
                            .color(getLineColor() != 0 ? getLineColor() : Color.argb(178, 0, 78, 255)).zIndex(14));
