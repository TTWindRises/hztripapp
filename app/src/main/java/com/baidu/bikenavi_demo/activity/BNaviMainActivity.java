...
public class BNaviMainActivity extends MyActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseNavGuide(msLocation,meLocation);
        NavGuideClick();

    }

    private void BaseNavGuide(LatLng startPt,LatLng endPt) {

        param = new BikeNaviLaunchParam().stPt(startPt).endPt(endPt);
        walkParam = new WalkNaviLaunchParam().stPt(startPt).endPt(endPt);
    }

    private void NavGuideClick() {
    ...
    private void initMapStatus(){
        ...
        builder.target(msLocation).zoom(19);
        mBaiduMap.setMapStatus(MapStatusUpdateFactory.newMapStatus(builder.build()));
    }

   /* public void initOverlay() {
        // add marker overlay
        LatLng llA = msLocation;
        LatLng llB = meLocation;
