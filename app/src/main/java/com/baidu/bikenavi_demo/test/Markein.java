package com.baidu.bikenavi_demo.test;
...
public class Markein extends MyActivity {
    ...
    private static final String LTAG = Markein.class.getSimpleName();
    ...
    private Animation getRotateAnimation() {
        ...
        mRotate.setAnimationListener(new Animation.AnimationListener() {
            ...
            @Override
            public void onAnimationEnd() {
                Toast.makeText(Markein.this,"haha",Toast.LENGTH_LONG).show();
